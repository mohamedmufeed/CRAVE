...
const loadOrder = async (req, res) => {
  ...
  module.exports = {loadCheckOut,defaultAddress,saveBillingAddress,placeOrder,thankyou,orderHistory,cancelOrder,orderDetails,loadOrder,serchOrder,orderStatus,admincancelOrder}